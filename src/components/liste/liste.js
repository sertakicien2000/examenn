...
export default class ListTout extends Component {
    ...
    componentDidMount() {
        axios.get('https://valimbavaka.herokuapp.com/api/users/newArticle')
            .then(response => {
                            ...
                            <div id="ligne" className="card" key={obj._id}>
                                <div className="container">
                                    <center><img className="card " width="50%" height="5%"
                                        src={'https://valimbavaka.herokuapp.com/api/users/newArticleImage/' + obj.image}
                                        alt="sary" /></center>
                                                            ...
                                                            <div id="mail" className='custom-ui'>
                                                                <div >
                                                                    ...
                                                                    <button type="button" class="btn btn-warning" onClick={() => {
                                                                        axios.post("https://valimbavaka.herokuapp.com/api/users/particulier/" + obj._id, {
                                                                            nom: this.state.nom,
                                                                            ...
                                                                            axios.get("https://valimbavaka.herokuapp.com/api/users/newArticle").then(res => {
