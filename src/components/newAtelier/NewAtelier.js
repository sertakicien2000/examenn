...
handleUploadImage(ev) {
  ...
  fetch('https://valimbavaka.herokuapp.com/api/users/newArticle/', {
    method: 'POST',
    body: data,
  }).then((response) => {
    response.json().then((body) => {
      this.setState({ image: `https://valimbavaka.herokuapp.com/api/users/newArticle/${body.image}` });
    ...
    return (
      <div className="container col md-4">
        <form onSubmit={this.handleUploadImage} className="md-form">
          <div className="form-group " id="ajoutatelier">
            <div className="row" >
